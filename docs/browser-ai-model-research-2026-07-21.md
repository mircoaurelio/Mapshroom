...
| Small | `onnx-community/Qwen2.5-Coder-0.5B-Instruct` | GLSL generation | ~0.4 GB | 2 GB+ free RAM |
| Medium | `onnx-community/Qwen2.5-Coder-1.5B-Instruct` | GLSL generation | ~1.1 GB | 4 GB+ free RAM |
| Big | `onnx-community/Qwen2.5-Coder-3B-Instruct` | GLSL generation | ~2.4 GB | 8 GB+ free RAM |
| Ultra | `onnx-community/Qwen3-4B-ONNX` | GLSL generation | ~2.9 GB | 12 GB+ free RAM, desktop WebGPU |
...
- Qwen 3 4B provides a larger browser-compatible ceiling where the Coder 7B ONNX build was not available as a dependable Transformers.js target.
...
- Qwen 3 4B ONNX model card: https://huggingface.co/onnx-community/Qwen3-4B-ONNX
