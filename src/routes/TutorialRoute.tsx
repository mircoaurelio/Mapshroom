    ...
    <main className="tutorial-page">
      ...
      <div id="steps" className="tutorial-steps">
        ...
        <section className="tutorial-step">
          ...
          <Media className="tutorial-ui-shot" src="assets/tutorial/workspace-overview.png" alt="Mapshroom workspace showing the Load asset control" marker={{ label: '1', x: '79%', y: '6%' }} />
        ...
        <section className="tutorial-step">
          ...
          <div className="tutorial-process-grid">
            ...
            <article className="tutorial-depth-card"><Media src="assets/onboarding/depth-map-normal.svg" alt="Generated depth map" /><span>Click 2</span><h3>Depth map</h3></article>
          </div>
