...
export function exportLighting(result: SurfaceResult, rgba: Uint8ClampedArray, width: number, height: number, nativeRgba: Uint8ClampedArray, options: LightingOptions, fieldOnly?: boolean): Uint8ClampedArray<ArrayBuffer>;
